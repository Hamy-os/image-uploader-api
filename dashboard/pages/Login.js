            ...
            <div className="bg-gray-900 dark:bg-gray-200 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
                ...
                <div className="md:flex w-full ">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5  md:px-10">
                        ...
                        <p className=" divide-y divide-gray-100 text-center">OR</p>
                        <form id="register"
